...
import static com.team2073.robot.AppConstants.Defaults.SAFE_PERCENT;
...
//	====================================================================================================================
	...
	public IMotorControllerEnhanced getLeftDriveMaster() {
		if(leftDriveMaster == null){
			leftDriveMaster = new EagleSRX(DRIVE_LEFT_TALON_PORT, LEFT_DRIVETRAIN_MOTOR_NAME, SAFE_PERCENT);
		}
	...
	public IMotorControllerEnhanced getRightDriveMaster() {
		if(rightDriveMaster == null){
			rightDriveMaster = new EagleSRX(DRIVE_RIGHT_TALON_PORT, RIGHT_DRIVETRAIN_MOTOR_NAME, SAFE_PERCENT);
		}
	...
	public IMotorControllerEnhanced getElevatorMaster() {
		if(elevatorMaster == null){
			elevatorMaster = new EagleSRX(ELEVATOR_TALON_PORT, ELEVATOR_MASTER_NAME, SAFE_PERCENT);
		}
	...
	public IMotorControllerEnhanced getIntakePivotMaster() {
		if(intakePivotMaster == null){
			intakePivotMaster = new EagleSRX(INTAKE_PIVOT_TALON_PORT, INTAKE_PIVOT_MASTER_NAME, SAFE_PERCENT);
		}
	...
	public IMotorController getLeftDriveSlave() {
		if(leftDriveSlave == null){
			leftDriveSlave = new EagleSRX(LEFT_DRIVE_VICTOR_PORT, LEFT_DRIVETRAIN_SLAVE_NAME, SAFE_PERCENT);
		}
	...
	public IMotorController getLeftDriveSlave2() {
		if(leftDriveSlave2 == null){
			leftDriveSlave2 = new EagleSRX(LEFT_DRIVE_VICTOR_2_PORT, LEFT_DRIVETRAIN_SLAVE_2_NAME, SAFE_PERCENT);
		}
	...
	public IMotorController getRightDriveSlave() {
		if(rightDriveSlave == null){
			rightDriveSlave = new EagleSRX(RIGHT_DRIVE_VICTOR_PORT, RIGHT_DRIVETRAIN_SLAVE_NAME, SAFE_PERCENT);
		}
	...
	public IMotorController getRightDriveSlave2() {
		if(rightDriveSlave2 == null){
			rightDriveSlave2 = new EagleSRX(RIGHT_DRIVE_VICTOR_2_PORT, RIGHT_DRIVETRAIN_SLAVE_2_NAME, SAFE_PERCENT);
		}
	...
	public IMotorController getElevatorSlave() {
		if(elevatorSlave == null){
			elevatorSlave = new EagleSRX(ELEVATOR_VICTOR_PORT, ELEVATOR_SLAVE_NAME, SAFE_PERCENT);
		}
	...
	public IMotorController getElevatorSlave2() {
		if(elevatorSlave2 == null){
			elevatorSlave2 = new EagleSRX(ELEVATOR_VICTOR_2_PORT, ELEVATOR_SLAVE_2_NAME, SAFE_PERCENT);
		}
	...
	public IMotorController getLeftShooter() {
		if(leftShooter == null){
			leftShooter = new EagleSPX(LEFT_SHOOTER_VICTOR_PORT, LEFT_SHOOTER_NAME, SAFE_PERCENT);
		}
		return leftShooter;
	}
	...
	public IMotorController getRightShooter() {
		if(rightShooter == null){
			rightShooter = new EagleSPX(RIGHT_SHOOTER_VICTOR_PORT, RIGHT_SHOOTER_NAME, SAFE_PERCENT);
		}
		return rightShooter;
	}
	...
	public IMotorController getIntakeRoller() {
		if(intakeRoller == null){
			intakeRoller = new EagleSPX(INTAKE_ROLLER_VICTOR_PORT, INTAKE_ROLLER_NAME, SAFE_PERCENT);
		}
		return intakeRoller;
	}
	...
	public IMotorController getIntakeRoller2() {
		if(intakeRoller2 == null){
			intakeRoller2 = new EagleSPX(INTAKE_ROLLER_VICTOR_2_PORT, INTAKE_ROLLER_2_NAME, SAFE_PERCENT);
		}
