...
public abstract class AppConstants {
	...
	public static class RobotPortsProperties {
		...
		private int deployStiltSolenoid;
		private int closeStiltSolenoid;
		...
		public int getDeployStiltSolenoid() {
			return deployStiltSolenoid;
		}

		public void setDeployStiltSolenoid(int deployStiltSolenoid) {
			this.deployStiltSolenoid = deployStiltSolenoid;
		}

		public int getCloseStiltSolenoid() {
			return closeStiltSolenoid;
		}

		public void setCloseStiltSolenoid(int closeStiltSolenoid) {
			this.closeStiltSolenoid = closeStiltSolenoid;
		}
